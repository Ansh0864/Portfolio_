    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="mb-10 sm:mb-16">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-zinc-900 tracking-tight uppercase">
            Work History & Experience
          </h2>
          
          <p className="text-xs sm:text-base text-zinc-500 mt-2 max-w-xl leading-relaxed">
